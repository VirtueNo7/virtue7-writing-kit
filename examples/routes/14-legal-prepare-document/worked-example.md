# Worked example: Prepare Legal Document

## User request

Prepare a reviewable memorandum from the approved legal evidence packet and supplied facts.
...
|---|---|
| Capability | `legal` |
| Route | `legal/prepare-document` |
| Profile | `legal_memorandum` |
| Form Lock | `adaptive` |
| Related playbooks | `legal/issue-and-authority-map`, `legal/chronology-and-exhibits` |
...
**Route contract applied:** Select a legal output profile. Draft from the legal evidence packet and supplied facts. Keep allegations, assumptions, and conclusions distinct. Include informational status when appropriate.
...
- Boot: three files
- Route packet: `runtime/packets/routes/legal--prepare-document.md` (5088 bytes)
...
```yaml
artifact_id: 14-legal-prepare-document
route: legal/prepare-document
profile: legal_memorandum
