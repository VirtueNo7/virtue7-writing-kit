# Worked example: Review Legal Document

## User request

Review this agreement against the supplied priorities, quoting the relevant language and separating law from questions.
...
|---|---|
| Capability | `legal` |
| Route | `legal/review-document` |
| Profile | `fact_check_report` |
| Form Lock | `preserve_form` |
| Related playbooks | `legal/contract-risk-pass` |
...
**Route contract applied:** Check jurisdiction, operative date, authority currency, citations, procedural posture, fact boundaries, requested relief, tone, confidentiality, and whether professional review is required.
...
- Boot: three files
- Route packet: `runtime/packets/routes/legal--review-document.md` (5084 bytes)
...
```yaml
artifact_id: 16-legal-review-document
route: legal/review-document
profile: fact_check_report
