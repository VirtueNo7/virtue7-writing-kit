...
Run a fixed evaluation case and report the raw classification, findings, repair, and regression result.
...
**Route contract applied:** Run representative and adversarial cases using fixed inputs, expected classifications, raw outputs, gate findings, repair results, and regression notes. Do not let average scores hide a catastrophic factual or governance failure.
...
- Boot: three files
- Route packet: `runtime/packets/routes/review--evaluation.md` (4049 bytes)
...
```yaml
artifact_id: 29-review-evaluation
route: review/evaluation
profile: fact_check_report
