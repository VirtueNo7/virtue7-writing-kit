# Worked example: Tailor Resume

## User request

Tailor the verified resume source to this role and expose every material change.
...
|---|---|
| Capability | `resume` |
| Route | `resume/tailor-resume` |
| Profile | `resume` |
| Form Lock | `adaptive` |
| Related playbooks | `career/targeted-resume` |
...
**Route contract applied:** Load the verified resume source, one job evidence packet, the resume profile, and the resume quality gate. Match requirements to evidence. Reorder and rewrite emphasis without inventing experience.
...
- Boot: three files
- Route packet: `runtime/packets/routes/resume--tailor-resume.md` (4087 bytes)
...
```yaml
artifact_id: 27-resume-tailor-resume
route: resume/tailor-resume
profile: resume
